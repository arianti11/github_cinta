...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="/">NamaProyek Pre</a>
    ...
    <div class="card h-100 shadow-sm">
        <div class="card-body">
            ...
            <ul class="list-group text-start">
                ...
                <li class="list-group-item"><strong>Sisa Waktu Studi:</strong> {{ $time_to_study_left }} hari</li>
                ...
                <div class="card h-100 shadow-sm">
                    <div class="card-body">
                        ...
                        <p class="font-custom">Kode yang rapi dan terstruktur, memudahkan Anda untuk mengubah konten
                            ...
                            <img src="{{ asset('assets/images/enjin.jpg') }}" alt="Logo">
                    </div>
                </div>
            </div>
        </div>
