...
@section('content')
    ...
    <div class="py-4">
        {{-- Breadcrumb dan Header (Dibiarkan Sesuai Asli) --}}
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                <li class="breadcrumb-item">
                    <a href="{{ route('home') }}"> {{-- Asumsi 'home' adalah route dashboard --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        type="email" {{-- Ganti ke type="email" --}}
                                        id="email"
                                        name="email"
                            ...
                            {{-- Kolom Kedua: Password dan Konfirmasi Password --}}
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        name="password_confirmation" {{-- INI NAMA YANG BENAR! --}}
                                        class="form-control"
                                        required
                                    >
